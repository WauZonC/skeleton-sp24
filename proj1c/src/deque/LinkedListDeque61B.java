...
public class LinkedListDeque61B<T> implements Deque61B<T> {
    ...
    public boolean equals(Object o) {
        if (o instanceof LinkedListDeque61B<?> otherList) {
    ...
    /**Implementing an iterator class nested in LinkedListDeque61B.*/
    private class DLLIterator implements Iterator<T> {

        private Node wizard;

        public DLLIterator() {
            this.wizard = sentinel.getLatter();
        }
        ...
        @Override
        public T next() {
            T returnValue = wizard.value();
            wizard = wizard.getLatter();
            return returnValue;
        }
    }
}
